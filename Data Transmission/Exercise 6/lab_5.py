...
def ASK(A1,A2,b):
    ...
    for n in range(0,B,1):
        for i in range(start,stop,1):
            ...
            czasASK.append(t)
            if b[n]==0:
                za_b0=A1*m.sin(2*m.pi*fn*czasASK[i])
                lask.append(za_b0)
            else:
                za_b1=A2*m.sin(2*m.pi*fn*czasASK[i])
                lask.append(za_b1)
        start=stop
    ...
    plt.title('ASK')
    plt.plot(czasASK,lask,label='z(t)')
    plt.legend()
    #plt.show()
...
def PSK(b):
    ...
    for n in range(0,B,1):
        for i in range(start,stop,1):
            ...
            czasPSK.append(t)
            if b[n]==0:
                zp_b0=m.sin(2*m.pi*fn*t)
                lpsk.append(zp_b0)
            else:
                zp_b1=zp_b0=m.sin(2*m.pi*fn*t+m.pi)
                lpsk.append(zp_b1)
        start=stop
        stop=stop+liczba_probek_na_jeden_sygnal
        if stop>int(N):
    ...
    #plt.title('PSK')
    plt.plot(czasPSK,lpsk,label='z(t)')
    plt.legend()
    #plt.show()
...
def FSK(b):
    ...
    for n in range(0,B,1):
        for i in range(start,stop,1):
            ...
            czasFSK.append(t)
            if b[n]==0:
                zf_b0=m.sin(2*m.pi*fn1*t)
                lfsk.append(zf_b0)
            else:
                zf_b1=m.sin(2*m.pi*fn2*t)
                lfsk.append(zf_b1)
        start=stop-1
        stop=stop+liczba_probek_na_jeden_sygnal
        if stop>int(N):
    ...
    #plt.title('FSK')
    plt.plot(czasFSK,lfsk,label='z(t)')
    plt.legend()
    #plt.show()
